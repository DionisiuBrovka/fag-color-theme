...
def build_color_theme(brightness: str, color: str, accent_color_dict: dict) -> dict:
    ...
    colors = {
        ...
        "textPreformat.foreground": CT[brightness]['foreground-5'],
        "textPreformat.background": ACT[color][brightness]['accent-down-3'],
        ...
        # ── Button control ──────────────────────────────────────────────
        "button.background": ACT[color][brightness]['accent-down-3'],
        ...
        "list.dropBackground": ACT[color]['accent-transparent-1'],      
